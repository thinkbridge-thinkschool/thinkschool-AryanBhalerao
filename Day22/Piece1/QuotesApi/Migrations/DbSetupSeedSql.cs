...
internal static class DbSetupSeedSql
{
...
('Lao Tzu',              'A journey of a thousand miles begins with a single step.',                                  '2026-03-03 08:30:00 +00:00', 3),
('William Shakespeare',  'To be, or not to be, that is the question.',                                               '2026-03-28 10:00:00 +00:00', 5),
...
-- ============================================================
-- QuoteCategories – remaining quotes
-- ============================================================

-- Classic (CategoryId = 1)
-- Twain, Wilde, Nietzsche, Franklin → classic AND modern
-- Lincoln, Gandhi, Aristotle, Emerson, Socrates, Confucius, Lao Tzu, Shakespeare → classic only
INSERT INTO [QuoteCategories] ([QuoteId], [CategoryId]) VALUES
(23, 1),   -- Twain        ""It ain't what you don't know...""
(35, 1),   -- Wilde        ""Always forgive your enemies...""
(40, 1),   -- Lincoln      ""In the end, it's not the years in your life...""
(41, 1),   -- Lincoln      ""Nearly all men can stand adversity...""
(44, 1),   -- Nietzsche    ""There are no facts, only interpretations.""
(46, 1),   -- Gandhi       ""An eye for an eye...""
(47, 1),   -- Gandhi       ""The weak can never forgive...""
(49, 1),   -- Aristotle    ""The more you know, the more you know you don't know.""
(50, 1),   -- Aristotle    ""Happiness depends upon ourselves.""
(53, 1),   -- Franklin     ""Early to bed and early to rise...""
(55, 1),   -- Emerson      ""The only way to have a friend is to be one.""
(56, 1),   -- Emerson      ""Life is a journey, not a destination.""
(61, 1),   -- Socrates     ""Education is the kindling of a flame...""
(62, 1),   -- Socrates     ""I know that I am intelligent...""
(64, 1),   -- Confucius    ""The man who asks a question...""
(65, 1),   -- Confucius    ""Life is really simple...""
(73, 1),   -- Lao Tzu      ""When I let go of what I am...""
(74, 1),   -- Lao Tzu      ""The flame that burns twice as bright...""
(76, 1),   -- Shakespeare  ""We know what we are, but know not what we may be.""
(77, 1);   -- Shakespeare  ""The course of true love never did run smooth.""

-- Modern (CategoryId = 2)
-- Twain, Wilde, Nietzsche, Franklin → classic AND modern
-- Einstein, Angelou, Churchill, Jobs → modern only
-- Roosevelt, Mandela, Ford → modern
INSERT INTO [QuoteCategories] ([QuoteId], [CategoryId]) VALUES
(13, 2),   -- Ford         ""Whether you think you can...""
(16, 2),   -- Roosevelt    ""Believe you can and you are halfway there.""
(17, 2),   -- Mandela      ""It always seems impossible until it is done.""
(23, 2),   -- Twain        ""It ain't what you don't know...""
(26, 2),   -- Einstein     ""The measure of intelligence is the ability to change.""
(29, 2),   -- Angelou      ""I've learned that people will never forget...""
(32, 2),   -- Churchill    ""Attitude is a little thing that makes a big difference.""
(35, 2),   -- Wilde        ""Always forgive your enemies...""
(38, 2),   -- Jobs         ""Design is not just what it looks like...""
(44, 2),   -- Nietzsche    ""There are no facts, only interpretations.""
(53, 2),   -- Franklin     ""Early to bed and early to rise...""
(57, 2),   -- Ford         ""Coming together is a beginning...""
(58, 2),   -- Ford         ""Failure is simply the opportunity to begin again...""
(59, 2),   -- Ford         ""Anyone who stops learning is old...""
(66, 2),   -- Roosevelt    ""Do what you can, with what you have, where you are.""
(67, 2),   -- Roosevelt    ""It is hard to fail...""
(68, 2),   -- Roosevelt    ""The best prize life offers...""
(69, 2),   -- Mandela      ""Education is the most powerful weapon...""
(70, 2),   -- Mandela      ""Do not judge me by my successes...""
(71, 2);   -- Mandela      ""A winner is a dreamer who never gives up.""


-- ============================================================
-- QuoteTags – remaining quotes
-- ============================================================
INSERT INTO [QuoteTags] ([QuoteId], [TagId]) VALUES
-- Mark Twain
(20, 9),   -- ""If you tell the truth...""                          → truth
(22, 2),   -- ""Twenty years from now...""                          → motivation
(23, 3),   -- ""It ain't what you don't know...""                   → humor

-- Albert Einstein
(25, 2),   -- ""A person who never made a mistake...""              → motivation
(26, 1),   -- ""The measure of intelligence...""                    → wisdom

-- Maya Angelou
(28, 7),   -- ""Try to be a rainbow...""                            → life
(29, 7),   -- ""I've learned that people...""                       → life

-- Winston Churchill
(30, 5),   -- ""If you're going through hell...""                   → perseverance
(31, 7),   -- ""We make a living by what we get...""                → life
(32, 2),   -- ""Attitude is a little thing...""                     → motivation

-- Oscar Wilde
(34, 3),   -- ""I can resist everything except temptation.""        → humor
(35, 3),   -- ""Always forgive your enemies...""                    → humor

-- Steve Jobs
(37, 2),   -- ""Stay hungry, stay foolish.""                        → motivation
(38, 6),   -- ""Design is not just what it looks like...""          → success

-- Abraham Lincoln
(39, 1),   -- ""Give me six hours to chop down a tree...""          → wisdom
(40, 7),   -- ""In the end, it's not the years in your life...""    → life
(41, 1),   -- ""Nearly all men can stand adversity...""             → wisdom

-- Friedrich Nietzsche
(43, 4),   -- ""He who has a why to live...""                       → philosophy
(44, 4),   -- ""There are no facts, only interpretations.""         → philosophy

-- Mahatma Gandhi
(45, 5),   -- ""Strength does not come from physical capacity...""  → perseverance
(46, 1),   -- ""An eye for an eye...""                              → wisdom
(47, 1),   -- ""The weak can never forgive...""                     → wisdom

-- Aristotle
(48, 1),   -- ""Knowing yourself is the beginning of all wisdom."" → wisdom
(49, 1),   -- ""The more you know, the more you know you don't know."" → wisdom
(50, 1),   -- ""Happiness depends upon ourselves.""                 → wisdom

-- Benjamin Franklin
(52, 6),   -- ""By failing to prepare, you are preparing to fail."" → success
(53, 1),   -- ""Early to bed and early to rise...""                 → wisdom

-- Ralph Waldo Emerson
(54, 1),   -- ""What lies within us...""                            → wisdom
(55, 7),   -- ""The only way to have a friend is to be one.""       → life
(56, 7),   -- ""Life is a journey, not a destination.""             → life

-- Henry Ford
(13, 2),   -- ""Whether you think you can...""                      → motivation
(57, 6),   -- ""Coming together is a beginning...""                 → success
(58, 5),   -- ""Failure is simply the opportunity to begin again..."" → perseverance
(59, 8),   -- ""Anyone who stops learning is old...""               → education

-- Socrates
(60, 1),   -- ""An unexamined life is not worth living.""           → wisdom
(61, 8),   -- ""Education is the kindling of a flame...""           → education
(62, 1),   -- ""I know that I am intelligent...""                   → wisdom

-- Confucius
(63, 1),   -- ""Everything has beauty, but not everyone sees it.""  → wisdom
(64, 1),   -- ""The man who asks a question...""                    → wisdom
(65, 1),   -- ""Life is really simple...""                          → wisdom

-- Theodore Roosevelt
(16, 2),   -- ""Believe you can and you are halfway there.""        → motivation
(66, 2),   -- ""Do what you can, with what you have...""            → motivation
(67, 5),   -- ""It is hard to fail...""                             → perseverance
(68, 6),   -- ""The best prize life offers...""                     → success

-- Nelson Mandela
(17, 5),   -- ""It always seems impossible until it is done.""      → perseverance
(69, 8),   -- ""Education is the most powerful weapon...""          → education
(70, 5),   -- ""Do not judge me by my successes...""                → perseverance
(71, 2),   -- ""A winner is a dreamer who never gives up.""         → motivation

-- Lao Tzu
(72, 1),   -- ""Nature does not hurry...""                          → wisdom
(73, 4),   -- ""When I let go of what I am...""                     → philosophy
(74, 1),   -- ""The flame that burns twice as bright...""           → wisdom

-- William Shakespeare
(75, 4),   -- ""All the world's a stage...""                        → philosophy
(76, 1),   -- ""We know what we are, but know not what we may be."" → wisdom
(77, 7);   -- ""The course of true love never did run smooth.""     → life
";
}