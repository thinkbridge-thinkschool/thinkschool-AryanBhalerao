...
namespace OrderApi.Services
{
    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderResponse> CreateOrderAsync(OrderRequest request, CancellationToken cancellationToken = default)
        {
            ...
            decimal totalWithTax = totalAmount + _taxCalculator.Calculate(totalAmount, request.ShippingAddress);
            ...
            var newOrder = new Order
            {
                ...
                OrderDate = _clock.UtcNow.UtcDateTime,
                Status = "Paid",
            ...
            return new OrderResponse
            {
                ...
                EstimatedDelivery = _clock.UtcNow.AddDays(3).ToString("yyyy-MM-dd")
            };
        }
