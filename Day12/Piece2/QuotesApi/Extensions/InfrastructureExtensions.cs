...
public static class InfrastructureExtensions
{
    ...
    public static void AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Both EF and Dapper implementations are registered as keyed services so the
        // benchmark endpoint can resolve them independently for a fair timing comparison.
        // The Dapper version is also the default (non-keyed) registration used by all
        // regular endpoints now that it has been validated as the faster read path.
        ...
        services.AddScoped<IQuoteQueryService, DapperQuoteQueryService>();
