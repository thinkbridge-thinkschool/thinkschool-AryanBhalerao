...
try
{
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        // Drop the auto-created FK index on Quotes.AuthorId to simulate a missing-index bug.
        // EF Core's ForeignKeyIndexConvention creates IX_Quotes_AuthorId; we remove it
        // so every per-author query in the slow endpoint does a full-table scan.
        db.Database.ExecuteSqlRaw("DROP INDEX IF EXISTS [IX_Quotes_AuthorId] ON [Quotes]");
